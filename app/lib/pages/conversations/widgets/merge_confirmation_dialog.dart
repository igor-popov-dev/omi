  ...
  Widget build(BuildContext context) {
    ...
    if (Platform.isIOS) {
      return CupertinoAlertDialog(
        ...
        actions: [
          CupertinoDialogAction(onPressed: onCancel, child: Text(context.l10n.cancel)),
          CupertinoDialogAction(onPressed: onConfirm, isDefaultAction: true, child: Text(context.l10n.merge)),
        ],
      );
    }

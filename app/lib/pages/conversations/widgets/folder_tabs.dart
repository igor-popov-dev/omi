          ...
          children: [
            if (icon != null) ...[
              Padding(
                ...
                child: OmiFolderIcon(icon, size: 12, color: isSelected ? effectiveColor : Colors.grey[400]),
              ),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: OmiFolderIcon(folder.icon, size: 20, color: Colors.red.withValues(alpha: 0.8)),
                      ),
                    ),

...
# as MESSAGES_BY_APP_ORDERED_QUERY, and it 500s independently of it because a
# chat session's first page of messages hits this branch, not the app-scoped one.
